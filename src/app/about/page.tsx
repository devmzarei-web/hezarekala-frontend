...
const DEFAULT_WORKSTATIONS: WorkstationData[] = [
  {
    ...
    description:
      "مجهز به دستگاه تراش سنگین ۶ متری با دهانه کارگیر ۱.۸ متر، فرز سنگین CNC سه متری مدل KF3000 اسپانیا، وایرکات مولتی‌کات سایز بزرگ، اسپارک الکترواروژن، دریل رادیال سنگین ۴ متری MEZ و تراش‌های تبریز جهت ماشین‌کاری قطعات با دقت میکرومتری.",
    equipment: "تراش ۶ متری (دهانه ۱.۸m)، فرز CNC سه متری KF3000، وایرکات، اسپارک، رادیال ۴m",
    capacity: "ماشین‌کاری قطعات سنگین تا قطر ۱۸۰۰ میلی‌متر و طول ۶ متر",
    icon: "machining",
  },
  {
    title: "واحد آهنگری، برش لیزری و نورد ورق تا ۶۰mm",
    description:
      "مجهز به دستگاه برش لیزری ۶ کیلووات با میز ۶ متری، نورد سنگین چهار غلطک تا ضخامت ۶۰ میلی‌متر (۶ سانتی‌متر)، پرس‌برک ۳ متری، ۲ دستگاه پرس ضربه‌ای و پانچ ۶۰ تن، گیوتین ۳.۲ متری و نورد لوله اتوماتیک.",
    equipment: "برش لیزر ۶kW شش متری، نورد ۴ غلطک ۶۰ میلی‌متری، پرس‌برک ۳ متری، پرس ۶۰ تن",
    capacity: "نورد و رولینگ ورق‌های ضخیم صنعتی تا ضخامت ۶۰ میلی‌متر و عرض ۳ متر",
    icon: "engineering",
  },
  {
    title: "واحد جوشکاری، آماده‌سازی سطح و اتاق رنگ",
    description:
      "شامل سامانه‌های جوشکاری لیزری، آرگون (TIG)، CO2 (MIG/MAG)، سیستم سندبلاست لیزری پیوسته، کابین سندبلاست، دستگاه وت‌بلاست پرتابل و اتاق رنگ مدرن با سیستم پاشش ایرلس (Airless) جهت اعمال رنگ‌های زینک ریچ، اپوکسی و پلی‌اورتان ضدخوردگی دریایی.",
    equipment: "جوش لیزری، TIG، MIG، سندبلاست لیزری، وت‌بلاست، ایرلس، اتاق رنگ مدرن",
    capacity: "آماده‌سازی سطح طبق استاندارد Sa 2.5 و پوشش‌دهی چندلایه شرایط حاد دریایی",
    icon: "qc",
  },
  {
    title: "ایستگاه آزمون هیدرواستاتیک و تست عملکرد پمپ",
    description:
      "لوپ مدار بسته و ایستگاه آزمون عملکرد هیدرولیکی پمپ‌ها شامل ثبت آنلاین دبی، هد، فشار، عمق مکش، بررسی کاویتاسیون، کنترل ارتعاش و استخراج منحنی عملکرد واقعی منطبق بر استاندارد بین‌المللی API 610 و ISO 5199.",
    equipment: "سنسورهای فشار پیزوالکتریک، فلومترهای کالیبره، گیج‌های تست هیدرواستاتیک",
    capacity: "آزمون هیدرواستاتیک بدنه و ارائه گواهینامه آزمون عملکرد کارخانه‌ای",
    icon: "testing",
  },
  {
    title: "سالن مونتاژ پکیج‌ها، لجستیک و تأمین برق مستقل",
    description:
      "خط تخصصی مونتاژ و کوپلینگ موتورهای دیزل، پمپ‌های دنده‌ای و خودمکش روی شاسی‌های یکپارچه پرتابل، مجهز به جرثقیل‌های سقفی ۵، ۱۰ و ۲۰ تن، لیفتراک ۷ تن و دیزل ژنراتور ۴۰۰ کاوا اختصاصی جهت استمرار تولید.",
    equipment: "جرثقیل‌های سقفی تا ۲۰ تن، لیفتراک ۷ تن، دیزل ژنراتور مستقل ۴۰۰kVA",
    capacity: "مونتاژ و بارگیری پکیج‌های پمپ فوق‌سنگین صنعتی",
    icon: "assembly",
  },
];

const DEFAULT_COMPANY_GROUNDS = [
  {
    title: "نمای اصلی کارخانه در شهرک صنعتی آبادان",
    description: "ورودی مجتمع صنعتی، ساختمان اداری و سالن‌های تولید",
  },
  {
    title: "سوله تولید و ساخت سازه‌های سنگین",
    description: "نمای بیرونی سالن اصلی ماشین‌کاری و مونتاژ پمپ‌ها",
  },
  {
    title: "محوطه باز و لجستیک کارخانه",
    description: "فضای استقرار و بارگیری تریلرها و ماشین‌آلات سنگین",
  },
  {
    title: "سالن توسعه و اسکلت فلزی جدید",
    description: "فاز توسعه فضای کارگاهی و خطوط تکمیلی کارخانه",
  },
];
